...
Security fixes are provided for the latest major version of Semantic Breadcrumb
Links. Please upgrade to the current release before reporting an issue. Fixes
...
[private vulnerability reporting](https://github.com/SemanticMediaWiki/SemanticBreadcrumbLinks/security/advisories/new).
...
Semantic Breadcrumb Links is an extension to MediaWiki that builds on Semantic
MediaWiki. If the issue is actually in one of those rather than in Semantic
Breadcrumb Links itself, please report it there instead:
